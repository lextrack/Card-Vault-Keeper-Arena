...
func _validate_nodes() -> bool:
	return background and border_highlight and inner_background and notification_title and notification_text and notification_detail and particle_effect
